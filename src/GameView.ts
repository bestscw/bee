...
class GameView extends egret.EventDispatcher
{
    ...
    public time_name:egret.TextField;
    ...
    public createStaticView(rootLayout:egret.DisplayObjectContainer,res:egret.SpriteSheet):void
    {
        ...
        var str:string = "小伙伴,敢不敢试试你能消除多少彩色方块！";
        this.weixinShare(str);
    }

    //创建分享界面界面
    private createShareBitmap(rootLayout:egret.DisplayObjectContainer,res:egret.SpriteSheet):void
    {
    ...
    private createGameBeginLayout(rootLayout:egret.DisplayObjectContainer):void
    {
        ...
        var btnPlay1:egret.Bitmap = new egret.Bitmap();
        ...
        var btnPlay2:egret.Bitmap = new egret.Bitmap();
        ...
        var btnPlay3:egret.Bitmap = new egret.Bitmap();
        ...
        var sm:egret.TextField = new egret.TextField();
    ...
    private createGameOverLayout(rootLayout:egret.DisplayObjectContainer,res:egret.SpriteSheet)
    {
        ...
        var record:egret.TextField = new egret.TextField();
        ...
        var newRecord:egret.TextField = new egret.TextField();
        ...
        var sprReplay:egret.Sprite = new egret.Sprite();
        ...
        var txtReplay:egret.TextField = new egret.TextField();
        ...
        var sprReturn:egret.Sprite = new egret.Sprite();
        ...
        var txtReturn:egret.TextField = new egret.TextField();
        ...
        var sprShare:egret.Sprite = new egret.Sprite();
    ...
    public showGameOverLayout()
    {
        ...
        var key:string = "beeGameMode_"+DataManage.mode;;
        var best:number = Number(egret.localStorage.getItem(key));
        ...
        if(DataManage.mode == 1)
        {
            ...
            var str:string ='我在【方块大扫除】指定时间内一口气消了'+DataManage.score+'个彩色方块，小伙伴们快来超越我吧！';
        ...
        else if(DataManage.mode == 2)
        {
            ...
            this.txtRecord.text = '当前记录:'+String(DataManage.score);
            var str:string ='我在【方块大扫除】指定步数内一口气消了'+DataManage.score+'个彩色方块，小伙伴们快来超越我吧！';
        }
        else  if(DataManage.mode == 3)
        {
            ...
            var str:string ='我在【方块大扫除】收集各种彩色方块耗时'+DataManage.collect_time+'，小伙伴们快来超越我吧！';
        }
    ...
    private onTouchOver(evt:egret.TouchEvent)
    {
        var arr:string[] = evt.target.name.split('_');
    ...
    private createColorContainer()
    {
        ...
        var sp4:egret.Sprite = new egret.Sprite();
